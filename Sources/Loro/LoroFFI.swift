...
open func deleteRootContainer(cid: ContainerId) {try! rustCall() {
    uniffi_loro_swift_fn_method_lorodoc_delete_root_container(self.uniffiClonePointer(),
...
open func setHideEmptyRootContainers(hide: Bool) {try! rustCall() {
    uniffi_loro_swift_fn_method_lorodoc_set_hide_empty_root_containers(self.uniffiClonePointer(),
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_loro_swift_checksum_method_lorodoc_delete_root_container() != 47485) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_loro_swift_checksum_method_lorodoc_set_hide_empty_root_containers() != 48824) {
        return InitializationResult.apiChecksumMismatch
    }
